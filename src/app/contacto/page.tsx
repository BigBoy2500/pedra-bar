      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-lg text-gray-700">Telemóvel</h3>
                <p className="text-gray-600">+351 933 834 749</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600"><span className="font-semibold">Segunda a Sexta: </span>10h30–2h00</p>
                <p className="text-gray-600"><span className="font-semibold">Sábado: </span>10h30–2h00</p>
                <p className="text-gray-600"><span className="font-semibold">Domingo: </span>10h30–2h00</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="text-center mt-4">
            <Link href="https://maps.google.com/maps?ll=41.615897,-8.748935&z=16&t=m&hl=pt-PT&gl=PT&mapclient=embed&cid=13733211774978343665" target="_blank" rel="noopener noreferrer" className="text-secondary hover:underline">
              Ver mapa maior
            </Link>
          </div>
        </div>
